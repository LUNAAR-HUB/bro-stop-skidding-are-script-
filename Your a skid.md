--from git hub-bro-stop-skidding-are-script-
Seriusly you will skid it you will put my github user and you will skid it

--[[ 
 what re you doing here?? you wanna skid are script:) 
 ]] 
 if not isfile("KavoConfig.JSON") then writefile("NeonPrivateConfig.JSON","{}") 
 end 
 wait(0.55) 
 spawn(function() 
...
TextLabel.MouseButton1Down:Connect(function()
	...
	print("some of the codings is from rekt sky")end)
...
game.StarterGui:SetCore("SendNotification", {
    ...
    Title = "Subcribe or else";

    Text = "the coding are skidded bc i dont who made the coding"; -- what the text says (ofc)
...
game.StarterGui:SetCore("SendNotification", {
    ...
    Text = "Subscribe to LUNAAR"; -- what the text says (ofc)
...
local window = kavoUi.CreateLib("Neon hub beta", "DarkTheme")
...
local Tab5Section = Tab5:NewSection("Made By narrator")
...
local Tab5Section =Tab5:NewSection("admin-LUNAR_XD dint help i just paid him to do it")
...
Tab1Section:NewSlider("Range 18-1", "", 18, 1, function(val) -- 500 (MaxValue) | 0 (MinValue) 
 ...
 Tab1Section:NewColorPicker("Color", "Adjust antivoid color", Color3.fromHSV(antivoidcolor["Hue"], antivoidcolor["Sat"], antivoidcolor["Value"]), function(val) 
         if antivoidp then 
                 antivoidp.Color = (val) 
         end 
 end) 
  
 Tab1Section:NewSlider("Invisible 1-100", "Adjust antivoid transparency", 100, 0, function(val) 
         if antivoidp then 
                 antivoidp.Transparency = 1 - (val / 100) 
         end 
 end) 
  
--you want to skid it really bro💀💀

--if your JN HH gaming and i saw you skidding my script bro stop

--plus you dont want to call you a skider you will obfucate it💀💀

--credits too rekt sky devs for some codings
